...
#' @return A numeric vector of price relatives, with `product` as names.
#' @seealso [`back_period()`][back_period] to get only the back price.
#' 
#' [`base_period()`][base_period] for making fixed-base price
#' relatives.
#' 
#' [carry_forward()] and [shadow_price()] to impute missing
#' prices.
#' 
#' [`outliers()`][outliers] for methods to identify outliers with
#' price relatives.
#' @examples
#' 
