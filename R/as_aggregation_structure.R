...
#' 
#' @param x An object to test or coerce into an aggregation structure.
...
#' `piar_aggregation_structure`, except for `is_aggregate_index()`
#' that returns `TRUE` if `x` inherits from
...
#' @describeIn as_aggregation_structure 
...
#' @describeIn as_aggregation_structure
#' The data frame methods treat `x` as a table with a row for
