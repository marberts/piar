...
Price indexes are often aggregated over multiple hierarchical
dimensions. Matched sample indexes that use sequential Poisson sampling
to draw a sample of businesses are a good example, as there are usually
take-all and take-some strata in addition to, say, an industry
classification.
...
concatenate them into one classification with the
`combined_classifications()` function. In this example the “stratum”
dimension comes before the “classification” dimension for the purposes
of overall-mean imputation.
...
```
    ...
    ##   11.TS      1 1.3007239 1.0630743 0.537996
    ##   11.TA      1 1.3007239 1.0630743 2.770456
    ##   12.TS      1 1.3007239 1.0630743 4.576286
