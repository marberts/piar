...
Let's extend `vignette("piar")` by adding another dimension to the classification to say if a business belong to the take-all or take-some sampling stratum.
...
Continuing with the example, the industry and strata classifications can be interacted to get two
