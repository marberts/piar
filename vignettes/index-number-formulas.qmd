...
Price indexes based on the generalized mean give a large family of
index-number formulas that are consistent in aggregation, and any index
based on the generalized mean can be used to make and aggregate
elemental indexes. To see how to make superlative indexes as well, let's
start with a simple dataset of prices and quantities for two businesses
over three periods. We'll be making extensive use of the *gpindex*
package for lower-level price-index functions; see the help pages for
that package to get more detail.
...
(equally-weighted arithmetic mean of price relatives) is the main
