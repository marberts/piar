...
is the fixed basket when making the index with the usual two-step procedure. This
...
until the index values converge to a fixed point.
...
adjust_weights <- function(index,
  ...
  for (i in seq_len(max_iter)) {
    ...
    # Stop if average price-update weight is within tolerance of original
  ...
  warning("weight adjustment did not converge")
  adj_pias
}
```
