...
Price indexes are often aggregated over multiple hierarchical dimensions. Matched
...
concatenate them into one classification with the `combined_classifications()`
function. In this example the "stratum"
